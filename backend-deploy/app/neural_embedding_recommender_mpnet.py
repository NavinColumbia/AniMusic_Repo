...
class MPNetRecommender:
    def __init__(self,
                 csv_path       = ROOT_DIR/"data"/"songs.csv",
                 embedding_path =   ROOT_DIR/"model_files"/"embeddings_mpnet.pkl"
                 ):
    ...
    def recommend(self, user_vec, candidate_ids=None, top_n=50):
        if user_vec is None:
            return []
